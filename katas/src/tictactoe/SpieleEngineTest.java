...
public class SpieleEngineTest {
	...
	public void alleZuegeUnentschieden() {
		...
		assertEquals(Spielstand.UNENTSCHIEDEN, engine.spielBeginnen());
	}
	...
	public void einsGewinnt() {
		...
		assertEquals(Spielstand.SPIELER_EINS_GEWINNT, engine.spielBeginnen());
	}
	...
	public void zweiGewinnt() {
		...
		assertEquals(Spielstand.SPIELER_ZWEI_GEWINNT, engine.spielBeginnen());
	}
